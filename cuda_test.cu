...
int main() {
    ...
    float h_data[SIZE] = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f};
    float h_result[SIZE];
    ...
    // Wait for the GPU to finish the computation and check for any errors during kernel execution
